...
<body>
	<a class="btn btn-outline-dark flex-shrink-0" style="margin: 10pt;"
		type="button" href="pizza?action=menu"> <i
		class="fa-solid fa-arrow-left"></i> Back to Menu
	</a>
	<!-- Product section-->
	<section class="py-5">
				...
				<div class="col-md-6">
					...
					<div class="d-flex">
						<input class="form-control text-center me-3" id="inputQuantity"
							type="number" value="1" name="qte" style="max-width: 4rem" /> <a
							class="btn btn-outline-dark flex-shrink-0" type="button"
							onclick="addToCart(${pizza.id})"> <i
								...
								<a href="pizza?action=detail&id=${relatedPizza.id}">
									<div class="card h-100">
										...
										<img class="card-img-top" height="250"
											src="${relatedPizza.image}" alt="${relatedPizza.nom}" />
										<!-- Product details-->
										<div class="card-body p-4">
											<div class="text-center">
												<h5
													style="color: black !important; text-decoration: none !important;">${relatedPizza.nom}</h5>
												<!-- Product price-->
												<span
													style="color: black !important; text-decoration: none !important;">${relatedPizza.prixBase}
													DT</span>
											</div>
										</div>
										<!-- Product actions-->
										<div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
											<div class="text-center">
												<a class="btn btn-outline-dark mt-auto"
													href="panier?action=add&pizzaId=${relatedPizza.id}"> <i
													class="bi-cart-fill me-1"></i> Add to cart
												</a>
											</div>
										</div>
