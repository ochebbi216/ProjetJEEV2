...
if (isAuthenticated) {
	...
	response.sendRedirect("../chefPages/"); // Update this with the path to your dashboard page
						...
						<div class="row">
							...
							<div class="col-12 col-xl-8 mb-4 mb-xl-0">
								...
								<h6 class="font-weight-normal mb-0">
									Managing Pizza Shop <span class="text-primary">Now!</span>
								</h6>
					...
					<div class="col-md-3 mb-4 stretch-card transparent">
						...
						<div class="card card-tale">
							...
							<div class="card-body">
								...
								<p class="fs-30 mb-2">${totalCommandes}</p>
